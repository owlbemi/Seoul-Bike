...
df_pop <- read.csv("/Users/owlbemi/seoul_bike/주민등록인구_20230915055038.csv", fileEncoding = "CP949", encoding = "UTF-8")
...
df_location <- df_location %>% select(-("운영.방식":"X.14"))
df_location <- df_location %>% select(-("설치.시기":"X.3"))
